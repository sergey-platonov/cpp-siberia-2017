        ...
        <div class="cpp-b_sidetext cpp-b_responsive-row-cols">
            ...
            <div class="sidetext-right row-col">
                ...
                <div class="cpp-b_block-text">
                    <p>Конференция C++ Siberia с блинами и матрёшками! Как всегда, лучшие докладчики<br>
                       со всей страны на два дня. Конференция ориентирована на опытных разработчиков, никаких вводных лекций!</p>
                    <p>Место проведения: Томский государственный университет (Томск, пр.Ленина, 36).<br>
                       В течение года сообщество проводит встречи в разных городах России: Москве, Санкт-Петербурге, Новосибирске, Екатеринбурге, Нижнем Новгороде, Саратове.<br>
                       На встречах выступают докладчики из разных городов и стран.</p>
                    <p>Заявки на доклады присылайте на <a href=mailto:talks@cpp-russia.ru>talks@cpp-russia.ru</a></p>
                </div>
    ...
    <div class="cpp-r_wrap">
        <div class="cpp-b_talks cpp-b_responsive-row-cols">
            ...
            <div class="cpp-b_talks_description row-col">
                ...
                <div class="cpp-b_block-text">
                    <p><strong>Подать заявку на доклад можно<br>до 15 августа 2017 года.</strong></p>
